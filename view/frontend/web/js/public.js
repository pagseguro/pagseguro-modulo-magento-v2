          ...
          jQuery
            ...
            .success(function (response) {
              if (response.success) {
                ...
                jQuery.each(response.payload.data.installments, function (
                  i,
                  item
                ) {
                  jQuery('#card_installments').append(
                    jQuery('<option>', {
                ...
                jQuery('#card-international').attr(
                  'data-target',
                  response.payload.data.cardInternational
                );

                //add card brand
                jQuery('#card-brand').attr(
                  'data-target',
                  response.payload.data.cardBrand
                );
